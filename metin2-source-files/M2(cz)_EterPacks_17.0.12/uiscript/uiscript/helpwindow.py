	...
	window = {
		...
		(
			...
			},
			{
				...
				"x" : SCREEN_WIDTH/2+45+20, "y" : SCREEN_HEIGHT - 116,
				"rect" : (0.0, -0.7, 0.0, 0.0),
				"image" : HELP_STICK_IMAGE_FILE_NAME,
			...
			},
			{
				...
				"x" : SCREEN_WIDTH/2-115, "y" : SCREEN_HEIGHT - 125,
			...
			},
			{
				...
				"x" : SCREEN_WIDTH/2-115, "y" : SCREEN_HEIGHT - 90,
				"rect" : (0.0, 0.0, -0.5, 0.0),
				"image" : HELP_STICK_LEFT_IMAGE_FILE_NAME,
			...
			},
			{
				...
				"x" : SCREEN_WIDTH/2-115, "y" : SCREEN_HEIGHT - 55,
				"rect" : (0.0, 0.0, -0.5, 0.0),
				"image" : HELP_STICK_LEFT_IMAGE_FILE_NAME,
			...
			},
			{
				...
				"x" : SCREEN_WIDTH/2+220, "y" :  SCREEN_HEIGHT-190,
